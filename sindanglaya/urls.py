...
urlpatterns = [
    path('', dashboard,name='sindanglaya'),
    path('list_swasta/', list_swasta,name='sindanglaya list swasta'),
    path('list_wiraswasta/', list_wiraswasta,name='sindanglaya list wiraswasta'),
    ...
    path('tambah_pns', tambah_kostumer,name='sindanglaya tambah_pns'),
    path('tambah_pegawai_swasta/', tambah_peg_swasta,name='sindanglaya tambah_pegawai_swasta'),
    path('tambah_wiraswasta/', tambah_wiraswasta,name='sindanglaya tambah_wiraswasta'),
    ...
    path('kavling/', data_kavling,name='sindanglaya kavling'),
    path('tambah_kavling/', tambah_kavling,name='sindanglaya tambah_kavling'),
    path('kavling/edit/<slug:slug>/', edit_kavling,name='sindanglaya edit_kavling'),
    path('kavling/hapus/<slug:slug>', hapus_kavling),


    path('marketer/', list_marketer,name='sindanglaya marketer'),
    path('tambah_marketer/', tambah_marketer,name='sindanglaya tambah_marketer'),
    path('kegiatan_marketing/', kegiatan_marketing,name='sindanglaya kegiatan_marketing'),
    path('marketer/laporan/<slug:slug>', laporan_marketing),
    path('marketer/hapus/<slug:slug>', hapus_marketer),



    path('laporan/', laporan,name='sindanglaya laporan'),
    path('dokumen_dan_progress/', progress,name='sindanglaya dokumen_dan_progress'),
    path('dokumen_dan_progress/hapus/<slug:slug>', hapus_kostumer),

    path('kpr/', progress2,name='sindanglaya progress_kpr'),
    path('rekap_akad/', rekap_akad,name='sindanglaya rekap_akad'),
