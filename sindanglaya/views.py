...
@user_passes_test(lambda u:u.is_superuser or u.email.endswith('@sindanglaya.com'))
def dashboard(request):
	...
	template = 'dashboard_sindanglaya/index.html'
	context = {
			'list_kostumer':qs,
			'tanggal':tanggal,
			}
...
def list_swasta(request):
	...
	template = 'dashboard_sindanglaya/list_swasta.html'
	context = {
			'list_kostumer':qs
			}
...
def list_wiraswasta(request):
	...
	template = 'dashboard_sindanglaya/list.wiraswasta.html'
	context = {
			'list_kostumer':qs
			}
...
def tambah_kostumer(request):
	template = 'dashboard_sindanglaya/tambahkonsumen-pns.html'
	form = TambahKostumerForm(request.POST,request.FILES or None)
	if request.method == 'POST':
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/sindanglaya/')
	context = {
		'form':form
	}
...
def tambah_peg_swasta(request):
	template = 'dashboard_sindanglaya/tambahkonsumen-swasta.html'
	form = TambahKostumerForm(request.POST,request.FILES or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/sindanglaya/list_swasta/')
	context = {
		'form':form
	}
...
def tambah_wiraswasta(request):
	template = 'dashboard_sindanglaya/tambahkonsumen-wiraswasta.html'
	form = TambahKostumerForm(request.POST,request.FILES or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/sindanglaya/list_wiraswasta/')
	context = {
		'form':form
	}
...
def edit_kostumer_pns(request,slug=None):
	...
	if request.method == 'POST':
		...
		obj.save()
		return HttpResponseRedirect("/sindanglaya/")
	template = "dashboard_sindanglaya/edit-pns.html"
	return render(request, template, context)
...
def edit_kostumer_swasta(request,slug=None):
	...
	if request.method == 'POST':
		...
		obj.save()
		return HttpResponseRedirect("/sindanglaya/list_swasta/")
	template = "dashboard_sindanglaya/edit-swasta.html"
	return render(request, template, context)
...
def edit_kostumer_wiraswasta(request,slug=None):
	...
	if request.method == 'POST':
		...
		obj.save()
		return HttpResponseRedirect("/sindanglaya/list_wiraswasta/")
	template = "dashboard_sindanglaya/edit-wiraswasta.html"
	return render(request, template, context)
...
def data_kavling(request):
	...
	template = 'dashboard_sindanglaya/kavling.html'
	context = {
			'list_kavling':qs
			}
...
def tambah_kavling(request):
	template = 'dashboard_sindanglaya/kavlingform.html'
	form = TambahKavlingForm(request.POST or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/sindanglaya/kavling/')
	context = {
		'form':form
	}
...
def list_marketer(request):
	...
	template = 'dashboard_sindanglaya/list_marketer.html'
	context = {
			'list_marketer':qs
			}
...
def tambah_marketer(request):
	template = 'dashboard_sindanglaya/marketertambah.html'
	form = TambahMarketerForm(request.POST or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/sindanglaya/marketer/')
	context = {
		'form':form
	}
...
def kegiatan_marketing(request):
	template = 'dashboard_sindanglaya/marketer.html'
...
def laporan_marketing(request,slug=None):
	...
	template = 'dashboard_sindanglaya/marketerlaporan.html'
	context = {
		'obj':obj,
		'kegiatan':kegiatan,
	}
...
def flpp_print(request,slug = None):
	...
	print(type(obj.tempat_lahir_pasangan))


	document.merge(Nama_PT='PT Berkah Jaya Bersama Propertindo',
 		TTL_Pemohon=obj.tempat_lahir +' '+ tanggal_lahir,
 		Nama_Perumahan='Bumi Sindanglaya Asri',
 		No_KTP_IstriSuami=obj.no_ktp_pasangan,
 		Alamat_Pemohon=obj.alamat,
 		Nama_Pemohon=obj.nama,
 		Alamat_SuamiIstri=obj.alamat_pasangan,
 		Nama_Direktur='',
 		TTL_IstriSuami=str(obj.tempat_lahir_pasangan) +' '+ tanggal_lahir_pasangan,
	...
	return render(request,'dashboard_sindanglaya/cetak.html',context)
...
def sphj_print(request,slug = None):
	...
	document.merge(nama_pt='PT Berkah Jaya Bersama Propertindo',
 		...
 		sisa_harus_bayar = str(obj.kavling.harga_standar +obj.kavling.klt +obj.kavling.hook - obj.kavling.plafon),
	...
	return render(request,'dashboard_sindanglaya/kwitansi2.html',context)
...
def laporan(request):
	...
	return render(request,'dashboard_sindanglaya/laporan1.html',context)
...
def progress(request):
	...
	return render(request,'dashboard_sindanglaya/dokumen_danprogress.html',context)
@user_passes_test(lambda u:u.is_superuser or u.email.endswith('@sindanglaya.com'))
def progress2(request):
	...
	return render(request,'dashboard_sindanglaya/progress.html',context)
...
def rekap_akad(request):
	...
	return render(request,'dashboard_sindanglaya/rekap_akad.html',context)
...
def hapus_kostumer(request,slug):
	...
	data.delete()
	return HttpResponseRedirect('/sindanglaya/dokumen_dan_progress/')
@user_passes_test(lambda u:u.is_superuser or u.email.endswith('@sindanglaya.com'))
