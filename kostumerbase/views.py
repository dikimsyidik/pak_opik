...
@user_passes_test(lambda u:u.is_superuser or u.email.endswith('@rancapari.com'))
def dashboard(request):
	...
	template = 'dashboard_rancapari/index.html'
	context = {
			'list_kostumer':qs,
			'tanggal':tanggal,
			}
...
def list_swasta(request):
	...
	template = 'dashboard_rancapari/list_swasta.html'
	context = {
			'list_kostumer':qs
			}
...
def list_wiraswasta(request):
	...
	template = 'dashboard_rancapari/list.wiraswasta.html'
	context = {
			'list_kostumer':qs
			}
...
def tambah_kostumer(request):
	template = 'dashboard_rancapari/tambahkonsumen-pns.html'
	form = TambahKostumerForm(request.POST,request.FILES or None)
	if request.method == 'POST':
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/rancapari/')
	context = {
		'form':form
	}
...
def tambah_peg_swasta(request):
	template = 'dashboard_rancapari/tambahkonsumen-swasta.html'
	form = TambahKostumerForm(request.POST,request.FILES or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/rancapari/list_swasta/')
	context = {
		'form':form
	}
...
def tambah_wiraswasta(request):
	template = 'dashboard_rancapari/tambahkonsumen-wiraswasta.html'
	form = TambahKostumerForm(request.POST,request.FILES or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/rancapari/list_wiraswasta/')
	context = {
		'form':form
	}
...
def edit_kostumer_pns(request,slug=None):
	...
	if request.method == 'POST':
		...
		obj.save()
		return HttpResponseRedirect("/rancapari/")
	template = "dashboard_rancapari/edit-pns.html"
	return render(request, template, context)
...
def edit_kostumer_swasta(request,slug=None):
	...
	if request.method == 'POST':
		...
		obj.save()
		return HttpResponseRedirect("/rancapari/list_swasta/")
	template = "dashboard_rancapari/edit-swasta.html"
	return render(request, template, context)
...
def edit_kostumer_wiraswasta(request,slug=None):
	...
	if request.method == 'POST':
		...
		obj.save()
		return HttpResponseRedirect("/rancapari/list_wiraswasta/")
	template = "dashboard_rancapari/edit-wiraswasta.html"
	return render(request, template, context)
...
def data_kavling(request):
	...
	template = 'dashboard_rancapari/kavling.html'
	context = {
			'list_kavling':qs
			}
...
def tambah_kavling(request):
	template = 'dashboard_rancapari/kavlingform.html'
	form = TambahKavlingForm(request.POST or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/rancapari/kavling/')
	context = {
		'form':form
	}
...
def list_marketer(request):
	...
	template = 'dashboard_rancapari/list_marketer.html'
	context = {
			'list_marketer':qs
			}
...
def tambah_marketer(request):
	template = 'dashboard_rancapari/marketertambah.html'
	form = TambahMarketerForm(request.POST or None)
	if form.is_valid():
		obj = form.save(commit=False)
		obj.save()
		return HttpResponseRedirect('/rancapari/marketer/')
	context = {
		'form':form
	}
...
def kegiatan_marketing(request):
	template = 'dashboard_rancapari/marketer.html'
...
def laporan_marketing(request,slug=None):
	...
	template = 'dashboard_rancapari/marketerlaporan.html'
	context = {
		'obj':obj,
		'kegiatan':kegiatan,
	}
...
def flpp_print(request,slug = None):
	...
	document.merge(Nama_PT='PT Eshan Mega Propertindo',
 		TTL_Pemohon=obj.tempat_lahir +' '+ tanggal_lahir,
 		Nama_Perumahan='Griya Rancapari',
	...
	return render(request,'dashboard_rancapari/cetak.html',context)
...
def sphj_print(request,slug = None):
	...
	return render(request,'dashboard_rancapari/kwitansi2.html',context)
...
def laporan(request):
	...
	return render(request,'dashboard_rancapari/laporan1.html',context)
...
def progress(request):
	...
	return render(request,'dashboard_rancapari/dokumen_danprogress.html',context)
@user_passes_test(lambda u:u.is_superuser or u.email.endswith('@rancapari.com'))
def progress2(request):
	...
	return render(request,'dashboard_rancapari/progress.html',context)
...
def rekap_akad(request):
	...
	return render(request,'dashboard_rancapari/rekap_akad.html',context)
...
def hapus_kostumer(request,slug):
	...
	data.delete()
	return HttpResponseRedirect('/rancapari/dokumen_dan_progress/')
@user_passes_test(lambda u:u.is_superuser or u.email.endswith('@rancapari.com'))
