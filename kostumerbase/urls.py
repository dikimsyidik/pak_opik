...
urlpatterns = [
    path('', dashboard,name='rancapari'),
    path('list_swasta/', list_swasta,name='rancapari list swasta'),
    path('list_wiraswasta/', list_wiraswasta,name='rancapari list wiraswasta'),
    ...
    path('tambah_pns', tambah_kostumer,name='rancapari tambah_pns'),
    path('tambah_pegawai_swasta/', tambah_peg_swasta,name='rancapari tambah_pegawai_swasta'),
    path('tambah_wiraswasta/', tambah_wiraswasta,name='rancapari tambah_wiraswasta'),
    ...
    path('kavling/', data_kavling,name='rancapari kavling'),
    path('tambah_kavling/', tambah_kavling,name='rancapari tambah_kavling'),
    path('kavling/edit/<slug:slug>/', edit_kavling,name='rancapari edit_kavling'),
    path('kavling/hapus/<slug:slug>', hapus_kavling),


    path('marketer/', list_marketer,name='rancapari marketer'),
    path('tambah_marketer/', tambah_marketer,name='rancapari tambah_marketer'),
    path('kegiatan_marketing/', kegiatan_marketing,name='rancapari kegiatan_marketing'),
    path('marketer/laporan/<slug:slug>', laporan_marketing),
    path('marketer/hapus/<slug:slug>', hapus_marketer),



    path('laporan/', laporan,name='rancapari laporan'),
    path('dokumen_dan_progress/', progress,name='rancapari dokumen_dan_progress'),
    path('dokumen_dan_progress/hapus/<slug:slug>', hapus_kostumer),

    path('kpr/', progress2,name='rancapari progress_kpr'),
    path('rekap_akad/', rekap_akad,name='rancapari rekap_akad'),
